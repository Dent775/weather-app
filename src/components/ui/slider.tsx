  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className="relative grow overflow-hidden rounded-full bg-sidebar-border data-horizontal:h-1.5 data-horizontal:w-full data-vertical:h-full data-vertical:w-1.5"
      >
